...
class PaymentModeDropDownAdapter(val context: Context, var listItemsTxt:  List<Instrument>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if(position==0){
        vh.label.text = listItemsTxt.get(position).instrumentName
